...
public class Serie implements Entregable {
    ...
    public String toString() {
        ...
        return "Estos son los DVD's de la serie: " + getTitulo()
    ...
    public String comparteTo(Object a, Object b) {
        ...
        if (a.getNtemporadas() == b.getNtemporadas()) {

            return "Tienen las mismas temporadas";
        }
        if (a.getNtemporadas() < b.getNtemporadas()) {
            return "La serie " + a.getTitulo() + " tiene menos"
                    + "temporadas que la serie " + b.getTitulo();
        }
