    ...
    public static int fromRomatoDecimal(String numroma) {
        ...
        for (int i = 0; i < numroma.length(); i++) {
            ...
            for (int j = 0; j < romanos.length; j++) {
                ...
                if (letra == romanos[j]) {
                    decimal = decimal + arabes[j];
                    //si el valor de letra anterior se realiza la ecuación valor-letra anterior x 2
                    if (letranterior < arabes[j]) {
                        decimal = decimal - letranterior * 2;
...
Ha de resoldre les següents operacions: “2+3”, “12-2”, “300*32”, “10%2”, etc.*/
    public static double calcular(String exp) {
        ...
        // Y con ésta, sacamos el operador
        ...
        for (String n : numeros) {
            ...
            arraycifras[i] = cifras;
            i++;
        }
       String simbolo="+";
        
        // ahora si me deja sustraerlo
