...
I si el nombre no és natural escriurà “El nombre no és major igual que zero”*/
    ...
    /**
     *
     * @param numero a comprobar si es perfecto
     */
    public static void nombreperfecte(int numero) {
        ...
        if (suma == numero) {
            ...
            System.out.println("FALSE " + "El nombre no és major igual que cero");
        }
    }
...
guardant i s’utilitzant dins les cridades recursives.*/
    ...
    /**
     *
     * @param limite valor de referencia para calcular el fibonnacci
     */
    ...
    /**
     *
     * @param posiciones numero de numeros, valga la redundancia, que tendrá la serie.
     * @return
     */
...
1444 */
    ...
    /**
     *
     * @param numroma numero romano a convertir en decimal
...
· getCantoDret (figura) = valor màxim de x on algun puntés TRUE */
    ...
    /**
     *
     * @param matriz de booleanos en la que se buscarán las esquinas
     * @return devuleve la esquina superior izquierda
     */
     ...
     *
     @param matriz de booleanos en la que se buscarán las esquinas
     * @return devuleve la esquina superior derecha
     */
     ...
     *
      @param matriz de booleanos en la que se buscarán las esquinas
     * @return devuleve la esquina inferior izquierda
     */
...
mètode que ens torni un array amb la fusió ordenada dels dos anteriors.*/
    ...
    /**
     *
     * @param matriz en la que se sumarán los valores de las filas y columnas
     */
    ...
    public static void sumaEnterosenArray(int[][] matriz) {
        ...
        for (int i = 0; i < columnas; i++) {
            for (int j = 0; j < columnas; j++) {
                resultadofilas = resultadofilas + matriz[i][j];

            }
            System.out.println("Suma fila " + (i + 1) + ": " + resultadofilas);
            resultadofilas = 0;
        }
        for (int i = 0; i < columnas; i++) {
            for (int j = 0; j < columnas; j++) {
                // cambiando de lugar los contadores realizamos las sumas de las columnas
                resultadofilas = resultadofilas + matriz[j][i];

            }
            System.out.println("Suma Columna " + (i + 1) + ": " + resultadofilas);
            resultadofilas = 0;
        }
    }
...
Ha de resoldre les següents operacions: “2+3”, “12-2”, “300*32”, “10%2”, etc.*/
    ...
    /**
     *
     * @param exp cadena de caracteres que forman la ecuación a calcular
...
System.out.println(iniSeries (llista).toString());*/
    ...
    /**
     *
     * @param serie arrays de numeros a ordenar
     * @return la serie ordenada
     */
    ...
    /**
     *
     * @param llista arrays de numeros primera a ordenar
     * @return Arraylist con todas las arrays 
     */
    public static ArrayList iniSeries(int[] llista) {
        // DUDA: Si la clase Arrays es una subclase de Objet...
        // ¿Por qué no me permite hacer un Arraylist de Arrays?
...
// la añado al ArraysList
        iniseries.add(llista);
// creo una segunda serie llamando al metodo.
        System.out.println("Segunda Serie:");
        int[] segunda =Ejercicios_2.crearSeries(llista);
// la añado al arraylist
        iniseries.add(segunda);
// Y así genero tres series más
System.out.println("Tercera Serie:");
int[] tercera =Ejercicios_2.crearSeries(segunda);
System.out.println("Cuarta Serie:");
int[] cuarta =Ejercicios_2.crearSeries(tercera);
System.out.println("Quinta Serie:");
int[] quinta =Ejercicios_2.crearSeries(cuarta);
iniseries.add(tercera);
iniseries.add(cuarta);
iniseries.add(quinta);
        return iniseries;
    }
    ...
    public static void main(String[] args) {
        ...
        // ejercicio 4
        //System.out.println(fromRomatoDecimal("MMXVIII"));
        // ejercicio 5
